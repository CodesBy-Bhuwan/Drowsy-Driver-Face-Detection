...
while(True):
    ...
    faces = face.detectMultiScale(gray,minNeighbors=5,scaleFactor=1.1,minSize=(100,100))
    ...
    if(Blink<0):
        Blink=0
    cv2.putText(frame,'Blink:'+str(Blink),(100,height-20), font, 1,(255,255,255),1,cv2.LINE_AA)
